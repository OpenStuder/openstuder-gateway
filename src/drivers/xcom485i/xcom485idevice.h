...
class XCom485iDevice: public SIDevice {
  public:
    explicit XCom485iDevice(const QString& model, quint8 modbusAddress, XCom485iModbusAccess* modbusAccess, const std::initializer_list<XCom58iProperty>& properties);
